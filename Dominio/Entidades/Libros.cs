...
public partial class Libros
{
    ...
    public virtual ICollection<LibrosAutores> LibroAutor { get; set; } = new List<LibrosAutores>();

    public virtual ICollection<LibrosTemas> LibroTema { get; set; } = new List<LibrosTemas>();
